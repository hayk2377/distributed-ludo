...
import (
	...
	pb "github.com/hayk2377/distributed-ludo/worker-node/LoadBalancer"
	"github.com/hayk2377/distributed-ludo/worker-node/database"
	"google.golang.org/grpc"
)

var PORT = GetPort()
var ip string = "127.0.0.1" + PORT
var client pb.LoadBalancerClient
...
func main() {
	...
	go func() {
		...
		if err != nil {
			fmt.Println("Error getting gRPC client:", err)
			return
		}
